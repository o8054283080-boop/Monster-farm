...
const TRIALS = [
  ...
  { n:10, label:'1ターンに5枚まで',    desc:'ラスボスの「創造の律」が全ての戦闘にかかる。1ターンに使えるカードが5枚までになる。あわせて敵の丈夫さがさらに+10(合計15)、ボスはこちらの丈夫さを25%無視する' },
];
...
// 試練10: 1ターンに使えるカードが5枚まで(ラスボスの「創造の律」を全戦闘にかける)。
// 【重要】敵が元から制限を持っているとき(65階ボスの7枚)は、cardPlayLimit() が厳しい方を採る
function trialCardPlayLimit(){ return trialHas(10) ? 5 : 0; }
...
const CHANGELOG = [
  { date:'2026/08/09', title:'連撃カードの攻撃予告がずれていた不具合を修正', items:[
    '連撃(複数ヒット)のカードで、敵にドラッグしたときの予告が「1発ぶん」しか出ていませんでした',
    '3連撃なら実際の3分の1、5連撃なら5分の1の数字が出ていたことになります',
    '実際に与えるダメージは今までどおりで、変わったのは予告の表示だけです',
    'モッチ砲の遺物で連撃が増えるぶんと、ゴッドライジングの連撃数も予告に入るようにしました',
  ]},
  { date:'2026/08/09', title:'ボスに「一撃の理」を追加', items:[
    '15階から60階までのボスが、連撃のダメージを下げ、連撃のない攻撃のダメージを上げる力を持つようになりました',
    '階が上がるほど効き目が強くなります。60階では連撃と単発がほぼ互角になります',
    '通常敵と強敵には一切かかりません。連撃デッキはこれまでどおり使えます',
    '効き目は画面の特殊効果マークから確認できます',
    '61階からのボスラッシュは今までどおりです',
  ]},
  { date:'2026/08/09', title:'図鑑（カード・遺物）を追加', items:[
    'タイトル画面に「📚 図鑑」を追加しました',
    'ゲームに出てくるカードを全部見られます。モンスターとレア度で絞り込めます',
    'カードを押すと効果を読めます',
    '遺物も全部見られます。通常の遺物とボス遺物を切り替えられ、モンスターごとの絞り込みもできます',
  ]},
  { date:'2026/08/09', title:'イブリースの形態変化がひと目で分かるように', items:[
    'カードの右上に、使ったあとどちらの形態になるかの印が付きました',
    '👼＝天使型になる、🌑＝通常形態に戻る、という意味です',
    '「形態が入れ替わる」カードは、いまの形態から見た行き先を出します。天使型なら🌑、通常形態なら👼です',
    'カードを長押ししたときの説明にも、いちばん上に大きく出るようにしました',
  ]},
