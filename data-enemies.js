...
const BOSS_DATA = {
15:{whimSingleMult:1.05,whimMultiMult:0.95,name:"オクレイマン",icon:"🏺",hp:650,dmg:28,trait:'okurei_15',img:'img/enemies/okurei_15.png',visual:'aura-purple'}, 30:{whimSingleMult:1.1,whimMultiMult:0.9,name:"マグマハート",icon:"🌋",hp:1200,dmg:39,trait:'magmaheart',img:'img/enemies/magmaheart.png',visual:'aura-red'}, 45:{whimSingleMult:1.15,whimMultiMult:0.85,name:"カーマイン",icon:"🃏",hp:1800,dmg:56,trait:'carmine',img:'img/enemies/carmine.png',visual:'aura-white'},
47:{whimSingleMult:1.15,whimMultiMult:0.8,name:"ポリトカ",icon:"👁️",hp:1650,dmg:52,trait:'politoka',img:'img/enemies/politoka.png',visual:'aura-white'}, 49:{whimSingleMult:1.2,whimMultiMult:0.78,name:"モスト",icon:"🍡",hp:1900,dmg:60,trait:'most',img:'img/enemies/most.png',visual:'aura-white'}, 50:{whimSingleMult:1.2,whimMultiMult:0.75,name:"ラグナ",icon:"🐉",hp:2500,dmg:65,trait:'ragna',img:'img/enemies/ragna.png',visual:'aura-black'},
52:{whimSingleMult:1.22,whimMultiMult:0.72,name:"ブラッディJ",icon:"👹",hp:2600,dmg:71,trait:'bloody',img:'img/enemies/bloody.png',visual:'aura-red'}, 54:{whimSingleMult:1.25,whimMultiMult:0.68,name:"真オクレイマン",icon:"🏺",hp:3700,dmg:65,trait:'okurei',img:'img/enemies/okurei.png',visual:'aura-purple'}, 56:{whimSingleMult:1.25,whimMultiMult:0.65,name:"本気のポリトカ",icon:"👁️",hp:3500,dmg:72,trait:'s_politoka',img:'img/enemies/s_politoka.png',visual:'aura-white'},
58:{whimSingleMult:1.28,whimMultiMult:0.6,name:"本気のモスト",icon:"🍡",hp:4000,dmg:76,trait:'s_most',img:'img/enemies/s_most.png',visual:'aura-white'}, 60:{whimSingleMult:1.3,whimMultiMult:0.55,name:"キングラグナ",icon:"🐉",hp:5200,dmg:85,trait:'king_ragna',img:'img/enemies/king_ragna.png',visual:'aura-black'},
